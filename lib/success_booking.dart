...
class _SuccessBookingPageState extends State<SuccessBookingPage> {
  ...
  void initState() {
    super.initState();
    qrData = createQRData(widget.userId, widget.appointmentId, widget.bookingDate, widget.bookingTime, widget.status);
  }

  String createQRData(int userId, int appointmentId, DateTime bookingDate, String bookingTime, String status) {
